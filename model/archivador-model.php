...
class ArchivadorModel extends Conexion {
    ...
    public function registrar_archivador_model() {
        try {
            $registro = "INSERT INTO tbl_archivadores (numeroArchivador, nombreArchivador, descripcionArchivador, estatusArchivador) 
                         VALUES (:numero, :nombre, :descripcion, :estatus)";
