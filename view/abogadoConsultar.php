<?php
    require_once __DIR__ . '/../controller/abogadoController.php';
                    ...
                    <div class="page-table-container">
                        ...
                        <table id="table" class="page-table">
                            ...
                            <?php foreach ($lista_abogados as $abogado) { ?>
                                <tr>
                                    <td><?php echo htmlspecialchars($abogado['cedulaAbogado']); ?></td>
                                    <td class="text-capitalize"><?php echo htmlspecialchars($abogado['nombreAbogado'] . ' ' . $abogado['apellidoAbogado']); ?></td>
                                    <td><?php echo htmlspecialchars($abogado['telefonoAbogado']); ?></td>
                                    <td><?php echo htmlspecialchars($abogado['correoAbogado']); ?></td>
                                    <td><?php echo htmlspecialchars($abogado['direccionAbogado']); ?></td>
                                    <td>
                                        <div class="page-table-buttons">
                                            <button class="btn-table-update" type="button">
                                            ...
                                            <button class="btn-table-delete" type="button">
