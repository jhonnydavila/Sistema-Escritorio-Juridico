                    ...
                    <form action="abogado" id="form" class="row p-4 gy-1" method="POST">
                        <div class="col-md-6">
                            <div class="form-group form-floating">
                                <input id="nombreAbogado" type="text" class="form-control" name="nombreAbogado" placeholder="john doe" minlength="3" maxlength="40" autocomplete="off" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-floating">
                                <input id="apellidoAbogado" type="text" class="form-control" name="apellidoAbogado" placeholder="john doe" minlength="3" maxlength="40" autocomplete="off" required>
                        ...
                        <div class="col-md-5 col-8">
                            <div class="form-group form-floating">
                                <input id="cedulaAbogado" type="text" class="form-control" name="cedulaAbogado" placeholder="john doe" minlength="3" maxlength="9" autocomplete="off" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-floating">
                                <input id="telefonoAbogado" type="text" class="form-control" name="telefonoAbogado" placeholder="john doe" maxlength="12" autocomplete="off" required>
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-floating">
                                <input id="direccionAbogado" type="text" class="form-control" name="direccionAbogado" placeholder="john doe" maxlength="200" autocomplete="off" required>
