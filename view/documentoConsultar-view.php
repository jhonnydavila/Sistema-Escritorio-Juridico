                                ...
                                <tbody>
                                    <?php if (!empty($data)){
                                        foreach ($data as $documento){ 
                                            if($documento['estatusDocumento'] == "Activo"){ 
                                                $rutaDescarga = ($documento['tipoDocumento'] == 'imagen') ? 'assets/uploads/images/' : 'assets/uploads/documents/';
                                                ?>
                                                <tr>
                                                    <td><?php echo $documento['codigoDocumento']; ?></td>

                                                    <?php if ($documento['tipoDocumento'] == 'imagen') { ?>
                                                        <td><span class="badge rounded-pill text-bg-dark text-capitalize"><?php echo $documento['tipoDocumento']; ?></span></td>
                                                    <?php } else { ?>
                                                    <td><span class="badge rounded-pill text-bg-success text-capitalize"><?php echo $documento['tipoDocumento']; ?></span></td>
                                                    <?php } ?>

                                                    <td><?php echo $documento['nombreDocumento']; ?></td>
                                                    <td><?php echo $documento['descripcionDocumento']; ?></td>
                                                    <td class="text-center">
                                                        <div class="table__buttons">
                                                            <a href="<?php echo $rutaDescarga . $documento['nombreDocumento']; ?>" download class="btn__table-download" title="Descargar Documento" style="display: inline-flex; align-items: center; justify-content: center; text-decoration: none;">
                        ...
                        <div class="table__container page__tab-panel w-100" id="panel-inactivos" style="display: none;">
                            <table id="table" class="table__content" style="width: 100%;">
                                ...
                                <tbody>
                                    <?php if (!empty($data)){
                                        foreach ($data as $documento){ 
                                            if($documento['estatusDocumento'] == "Inactivo"){ 
                                                $rutaDescarga = ($documento['tipoDocumento'] == 'imagen') ? 'assets/uploads/images/' : 'assets/uploads/documents/';
                                                ?>
                                                <tr>
                                                    <td><?php echo $documento['codigoDocumento']; ?></td>
