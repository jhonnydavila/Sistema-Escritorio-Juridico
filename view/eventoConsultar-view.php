                        ...
                        <table id="table" class="table__content">
                            ...
                            <tbody>
                                <tr>
                                    <td>EVE-001</td>
                                    <td>CAS-001</td>
                                    <td>Audiencia Civil</td>
                                    <td>Audiencia</td>
                                    <td>03/05/2002</td>
                                    <td>Audiencia preliminar en tribunal civil</td>
                                ...
                                <tr>
                                    <td>EVE-001</td>
                                    <td>CAS-001</td>
                                    <td>Reunión con los abogados</td>
                                    <td>Reunión</td>
                                    <td>03/05/2002</td>
                                    <td>Audiencia preliminar en tribunal civil</td>
                                    <td><span class="badge rounded-pill text-bg-secondary">En Espera</span></td>
                                    <td>
                                        <div class="table__buttons">
                                            <button class="btn__table-update" title="Modificar Evento">
                                                <svg width="1rem" height="1rem" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-pencil-line-icon lucide-pencil-line"><path d="M13 21h8"/>
                                ...
                                <tr>
                                    <td>EVE-001</td>
                                    <td>CAS-001</td>
                                    <td>Cita con felipe</td>
                                    <td>Cita</td>
                                    <td>03/05/2002</td>
                                    <td>Audiencia preliminar en tribunal civil</td>
                                    <td><span class="badge rounded-pill text-bg-danger">Suspendido</span></td>
                                    <td>
                                        <div class="table__buttons">
                                            <button class="btn__table-update" title="Modificar Evento">
                                                <svg width="1rem" height="1rem" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-pencil-line-icon lucide-pencil-line"><path d="M13 21h8"/>
