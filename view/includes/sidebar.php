<div class="sidebar__container">
    ...
    <nav class="sidebar__nav">
        ...
        <div class="sidebar__nav-item-dropdown">
            ...
            <form action="?page=usuario" method="POST" class="sidebar__nav-dropdown-menu">
                <button type="submit" class="sidebar__nav-item" name="usuarioRegistrar"><span>Registrar Usuario</span></button>
                <button type="submit" class="sidebar__nav-item" name="usuarioConsultar"><span>Consultar Usuarios</span></button>
            </form>
        </div>
        ...
        <div class="sidebar__nav-item-dropdown">
            ...
            <form action="?page=tramite" method="POST" class="sidebar__nav-dropdown-menu">
                <button type="submit" class="sidebar__nav-item" name="tramiteRegistrar"><span>Registrar Trámite</span></button>
                <button type="submit" class="sidebar__nav-item" name="tramiteConsultar"><span>Consultar Trámites</span></button>
            </form>
        </div>
        ...
        <div class="sidebar__nav-item-dropdown">
            ...
            <form action="?page=honorario" method="POST" class="sidebar__nav-dropdown-menu">
                <button type="submit" class="sidebar__nav-item" name="honorarioRegistrar"><span>Registrar Honorario</span></button>
                <button type="submit" class="sidebar__nav-item" name="honorarioPagoRegistrar"><span>Registrar Pago</span></button>
                <button type="submit" class="sidebar__nav-item" name="honorarioConsultar"><span>Consultar Honorarios</span></button>
            </form>
        </div>
        ...
        <div class="sidebar__nav-item-dropdown">
            ...
            <form action="?page=archivador" method="POST" class="sidebar__nav-dropdown-menu">
                <button type="submit" class="sidebar__nav-item" name="archivadorRegistrar"><span>Registrar Archivador</span></button>
                <button type="submit" class="sidebar__nav-item" name="archivadorConsultar"><span>Consultar Archivadores</span></button>
            </form>
        </div>
