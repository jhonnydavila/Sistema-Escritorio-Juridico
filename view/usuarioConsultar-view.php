            ...
            <section class="page__container">
                <div class="page__header">
                    <div class="page__header-titles">
                        <h2 class="page__header-title">Consultar Usuarios</h2>
                        <span class="page__header-subtitle">Gestión de Usuarios</span>
                    </div>
                </div>
                                            ...
                                            if($usuario['estatusUsuario'] == "Activo"){ ?>
                                                <tr class="text-capitalize">
                                                    ...
                                                    <?php if ($usuario['rolUsuario'] == "secretaria") { 
                                                        ...
                                                        echo "<td><span class='badge rounded-pill text-bg-dark'>Administrador</span></td>";
                                                    } else if ($usuario['rolUsuario'] == "abogado") {
                                                        echo "<td><span class='badge rounded-pill text-bg-primary'>Abogado</span></td>";
                                                    } ?>
                                                    <td><?php echo $usuario['fechaRegistroUsuario']?></td>
                                                    <td>
                                                        <div class="table__buttons">
                                                            <button class="btn__table-update" title="Modificar Usuario">
                                                            ...
                                                            <button class="btn__table-delete" title="Eliminar Usuario">
