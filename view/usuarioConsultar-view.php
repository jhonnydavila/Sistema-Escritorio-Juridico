                        ...
                        <table id="table" class="table__content">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>Gómez</td>
                                    <td>03/05/2002</td>
                                    <td><span class="badge rounded-pill text-bg-secondary">Secretaria</span></td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>Gómez</td>
                                    <td>03/05/2002</td>
                                    <td><span class="badge rounded-pill text-bg-dark">Administrador</span></td>
                                    <td>
                                        <div class="table__buttons">
                                            <button class="btn__table-update" title="Modificar Usuario">
                                                <svg width="1rem" height="1rem" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-pencil-line-icon lucide-pencil-line"><path d="M13 21h8"/>
                                ...
                                <tr>
                                    ...
                                    <td>Gómez</td>
                                    <td>03/05/2002</td>
                                    <td><span class="badge rounded-pill text-bg-primary">Abogado</span></td>
                                    <td>
                                        <div class="table__buttons">
                                            <button class="btn__table-update" title="Modificar Usuario">
                                                <svg width="1rem" height="1rem" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-pencil-line-icon lucide-pencil-line"><path d="M13 21h8"/>
